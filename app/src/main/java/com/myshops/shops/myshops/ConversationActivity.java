...
import com.myshops.shops.bean.DemoContext;
...
public class ConversationActivity extends FragmentActivity {
    ...
    private void enterFragment(Conversation.ConversationType mConversationType, String mTargetId) {
        ...
        ConversationFragment fragment = (ConversationFragment) getSupportFragmentManager().findFragmentById(R.id.conversations);
